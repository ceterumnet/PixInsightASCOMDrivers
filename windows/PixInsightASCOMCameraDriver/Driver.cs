...
//
// ASCOM Camera driver for PixInsightASCOMCameraDriver
//
...
namespace ASCOM.PixInsightASCOMCameraDriver
{
    //
    // Your driver's ID is ASCOM.PixInsightASCOMCameraDriver.Camera
    //
    // The Guid attribute sets the CLSID for ASCOM.PixInsightASCOMCameraDriver.Camera
    // The ClassInterface/None addribute prevents an empty interface called
    // _Camera from being created and used as the [default] interface
    //
    [Guid("d522c383-9547-4e2e-a450-69362147bdff")]
    [ServedClassName("PixInsightASCOMCameraDriver Camera")]
    [ProgId("ASCOM.PixInsightASCOMCameraDriver.Camera")]
    ...
    public class Camera : ICameraV2
    {
        ...
        //
        private static string driverId = "ASCOM.PixInsightASCOMCameraDriver.Camera";
        // TODO Change the descriptive string for your driver then remove this line
        private const string driverDescription = "PixInsightASCOMCameraDriver Camera";
        #endregion
